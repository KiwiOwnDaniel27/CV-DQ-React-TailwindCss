const Footer = () => {
    return (
        <div className="mt-11 py-4 flex md:flex-row flex-col gap-6 md:gap-0 justify-between items-center">
            <h1 className="text-2xl font-bold">Portafolio</h1>
            <div className="flex gap-9 ml-0 sm:ml-20">
                <a href="#inicio">Ir a Inicio</a>
                <a href="#certificados">Certificaciones</a>
                <a href="#project">Proyectos</a>
            </div>
            <div className="flex items-center gap-3 mb-27 md:mb-0">
